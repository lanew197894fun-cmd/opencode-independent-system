# ═══════════════════════════════════════════════════════════════════════
# ║  🦞 OpenCode 安裝腳本 v2.0 (PowerShell)                         ║
# ║  自動檢測環境 • 一鍵安裝 • 跨平台支援                              ║
# ═══════════════════════════════════════════════════════════════════════
#
# 說明：
#   這是 OpenCode 的 Windows 安裝精靈，協助檢測環境並完成安裝。
...
#   [2] 安裝依賴   - 安裝 OpenCode 和 OpenCode 依賴
