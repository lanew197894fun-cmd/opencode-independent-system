...
├── sync-to-storage.sh      # 同步 OpenClaw 配置到外接儲存
...
# 從外接儲存還原
./toolbox.sh restore /media/reamaster/USB/OpenClaw_Backup_20260317
...
| 專案             | 路徑                                           | 大小  |
| ---------------- | ---------------------------------------------- | ----- |
| OpenClaw Manager | ~/openclaw-manager                             | ~8.8G |
| OpenClaw 龍蝦    | ~/openclaw-manager/openclaw                    | ~2.7G |
| OpenCode 開發    | ~/openclaw-manager/opencode independent system | ~2.1G |
| OpenCode 配置    | ~/.opencode                                    | ~144M |
| OpenClaw 配置    | ~/.openclaw                                    | ~450M |
